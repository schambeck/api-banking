...
public class CreateTransferenciaInteractor {
    ...
    @Transactional
    public Transferencia execute(DadosConta dadosContaOrigem, DadosConta dadosContaDestino, BigDecimal valor) {
        ...
        return createTransferencia.execute(contaOrigem, contaDestino, valor);
    }
}
